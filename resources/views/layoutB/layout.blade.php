                ...
                <div class="side-nav-content">
                    <ul class="nav-list">
                        <li class="nav-list-item">
                            ...
                            <span>
                                <a href="/home-user-list">Usuarios</a>
                            </span>
                        </li>
                        <li class="nav-list-item">
                            <i class="fa-solid fa-key"></i>
                            <span>
                                <a href="/home-roles-list">Roles</a>
                            </span>
                        </li>
                        <li class="nav-list-item">
                            <i class="fa-solid fa-building-columns"></i>
                            <span>
                                <a href="/home-facultades-list">Facultades</a>
                            </span>
                        </li>
                        <li class="nav-list-item">
                            <i class="fa-solid fa-book-open"></i>
                            <span>
                                <a href="/home-asignaturas-list">Asignaturas</a>
                            </span>
                        </li>
                        <li class="nav-list-item">
                            ...
                            <span>
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark">
                                    <li><a class="dropdown-item" href="/home-tutorias-list">Tutorias</a></li>
